# E-mail Resumo de Processamento: este script verifica se todos os layouts dos arquivos de carga de Sábado da Via Varejo 18 e 55 foram processados 
...
$order = @("Carga 18", "Carga 55", "Arquivos PA 18", "Arquivos PA 55", "Arquivos SUSP 18", "Arquivos SUSP 55", "Arquivos Retorno")
